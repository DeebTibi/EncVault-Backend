...
const (
	UserAuth_Register_FullMethodName          = "/user_auth.UserAuth/Register"
	UserAuth_Login_FullMethodName             = "/user_auth.UserAuth/Login"
	UserAuth_AuthenticateToken_FullMethodName = "/user_auth.UserAuth/AuthenticateToken"
)
...
type UserAuthClient interface {
	...
	AuthenticateToken(ctx context.Context, in *AuthenticateTokenRequest, opts ...grpc.CallOption) (*wrappers.BoolValue, error)
}
...
func (c *userAuthClient) AuthenticateToken(ctx context.Context, in *AuthenticateTokenRequest, opts ...grpc.CallOption) (*wrappers.BoolValue, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(wrappers.BoolValue)
	err := c.cc.Invoke(ctx, UserAuth_AuthenticateToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserAuthServer interface {
	...
	AuthenticateToken(context.Context, *AuthenticateTokenRequest) (*wrappers.BoolValue, error)
...
func (UnimplementedUserAuthServer) AuthenticateToken(context.Context, *AuthenticateTokenRequest) (*wrappers.BoolValue, error) {
...
func _UserAuth_AuthenticateToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuthenticateTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserAuthServer).AuthenticateToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserAuth_AuthenticateToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserAuthServer).AuthenticateToken(ctx, req.(*AuthenticateTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserAuth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserAuth_AuthenticateToken_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "services/user_auth/api/UserAuth.proto",
}
